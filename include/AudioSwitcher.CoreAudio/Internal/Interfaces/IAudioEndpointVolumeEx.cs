...
internal interface IAudioEndpointVolumeEx
{
    ...
    int SetChannelVolumeLevel(
        [In][MarshalAs(UnmanagedType.SysUInt)] nuint channelNumber,
        [In][MarshalAs(UnmanagedType.R4)] float level,
        [In] ref Guid eventContext);
    ...
    int GetVolumeStepInfo(
        [Out][MarshalAs(UnmanagedType.SysUInt)] out nuint step,
        [Out][MarshalAs(UnmanagedType.SysUInt)] out nuint stepCount);
